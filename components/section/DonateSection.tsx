    ...
    <div className="py-[10vh] px-5 lg:px-[12vw] bg-[--clr-grey-extralight] relative h-full flex flex-col">
      <div className="flex flex-col md:flex-row gap-10 items-center justify-between">
        <div className="flex flex-col gap-2">
          <span className="text-5xl ft-cooper">
            Support the Divine Wounds Orphanage in Enugu, Nigeria.
          </span>
          <div className="mb-3">
            <p className="text-lg">
              By donating today, you become a vital part of our efforts to
              foster social good, educational development, and the well-being
              of children.
            </p>
          </div>
